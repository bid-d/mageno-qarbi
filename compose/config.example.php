...
return [
    'modules' => [
        ...
        'IWD_Opc' => 0,
        'Jajuma_Vendor' => 1,
        'Jajuma_AdvancedWidget' => 1,
        'Jajuma_Catalog' => 1,
        'Jajuma_General' => 1,
        'Jajuma_CustomerNavigation' => 1,
        'Jajuma_DynamicShippingTax' => 1,
        'Jajuma_ContinueShoppingUrlRewrite' => 1,
        'Jajuma_HelpDesk' => 1,
        'Jajuma_HerbalPortraits' => 0,
        'Jajuma_HerbalPortraitsComment' => 0,
        'Jajuma_HerbalPortraitsUrlRewrite' => 0,
        'Jajuma_ImportExport' => 1,
        'Jajuma_MailCatcher' => 1,
        'Jajuma_Megamenu' => 1,
        'Jajuma_Newsletter' => 1,
        ...
        'Jajuma_Shariff' => 1,
        'Jajuma_Slider' => 1,
        'Jajuma_VendorShipping' => 1,
        'Jajuma_AdvancedCheckout' => 0,
        'Jajuma_VendorTableRate' => 1,
        'Jajuma_YouTubeWidget' => 1,
        ...
        'ShipperHQ_Tracker' => 1,
        'Temando_Shipping' => 0,
        'Tigren_CronjobManager' => 1,
        'Vertex_Tax' => 0,
        'Wyomind_Framework' => 1,
        'Jajuma_OrderEraser' => 1,
        'Xtento_XtCore' => 1,
